...
awslocal lambda create-function \
    ...
    --environment "Variables={DYNAMODB_TABLE_VERIFIER_ENDPOINT=$DYNAMODB_TABLE_VERIFIER_ENDPOINT,API_BASE_URL=$API_BASE_URL,API_VERSION=$API_VERSION,API_KEY=$API_KEY,ACCESS_TOKEN=$ACCESS_TOKEN,AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY,DYNAMODB_ENDPOINT=$DYNAMODB_ENDPOINT,AWS_DEFAULT_REGION=$AWS_DEFAULT_REGION}"
